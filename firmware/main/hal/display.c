...
static void backlight_init(void)
{
    ...
    ledc_channel_config_t ch_cfg = {
        ...
        .duty = DISPLAY_BL_INVERT ? 255 : 0,
        .hpoint = 0,
    };
    ledc_channel_config(&ch_cfg);
}

static void backlight_set_pct(uint8_t brightness_pct)
{
...
esp_err_t hal_display_init(lv_display_t **disp_out)
{
    ...
    *disp_out = lvgl_port_add_disp(&disp_cfg);
    ...
    lv_display_set_default(*disp_out);

    backlight_set_pct(80);
